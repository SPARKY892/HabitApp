...
const GoalStatOverview = () => {
  ...
  return (
    <Container width={`${screenWidth}px`}>
      ...
      <BackgroundImage source={require("@assets/images/goalstats.jpg")} />
      <TextWrapper>
        <HeaderText>Track Your Progress</HeaderText>
        <PageText>
          Stay motivated by tracking your progress every step of the way. Build
          consitency with streaks.
        </PageText>
      </TextWrapper>
    </Container>
  );
...
export default GoalStatOverview;
